...
def create_game_board(grid_size):
    ...
    for cell_index in range(grid_size * grid_size):
        ...
        glColor3f(0.2, 0.8, 0.2) if use_primary_color else glColor3f(0.15, 0.6, 0.15)
        ...
        tile_corners = [
            ...
            (x_position + TILE_SIZE, y_position, 0),
            (x_position + TILE_SIZE, y_position + TILE_SIZE, 0),
            (x_position, y_position + TILE_SIZE, 0)
        ]
...
def render_collectible_item():
    ...
    glPushMatrix()
    glRotatef(90, 1, 0, 0)
    coin_radius = 40  # Increased from 25 to 40 to make it bigger
    coin_thickness = 8  # Increased from 5 to 8 to make it thicker
